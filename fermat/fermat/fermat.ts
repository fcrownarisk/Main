...
void function fermat() {
    void ['BIgXtensor' + `midxtensor` + 'smallxtensor`===`BigYtensor`+`midytensor`+`smalltensor`=== `BigYtensor + smallytensor + smallztensor']
    void ['BIgXtensor - smallxtensor' + 'BigYtensor - smallytensor' +'BigZtensor - smallztensor']
